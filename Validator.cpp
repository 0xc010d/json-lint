...
Validator::Validator(const Schema &schema) : m_schema(schema), m_validators{
  {"$ref",                 &Validator::validate_$ref},
  {"additionalItems",      &Validator::validate_additionalItems},
  {"additionalProperties", &Validator::validate_additionalProperties},
  {"allOf",                &Validator::validate_allOf},
  {"anyOf",                &Validator::validate_anyOf},
  {"dependencies",         &Validator::validate_dependencies},
  {"enum",                 &Validator::validate_enum},
  {"format",               &Validator::validate_format},
  {"items",                &Validator::validate_items},
  {"maxItems",             &Validator::validate_maxItems},
  {"maxLength",            &Validator::validate_maxLength},
  {"maxProperties",        &Validator::validate_maxProperties},
  {"maximum",              &Validator::validate_maximum},
  {"minItems",             &Validator::validate_minItems},
  {"minLength",            &Validator::validate_minLength},
  {"minProperties",        &Validator::validate_minProperties},
  {"minimum",              &Validator::validate_minimum},
  {"multipleOf",           &Validator::validate_multipleOf},
  {"not",                  &Validator::validate_not},
  {"oneOf",                &Validator::validate_oneOf},
  {"pattern",              &Validator::validate_pattern},
  {"patternProperties",    &Validator::validate_patternProperties},
  {"properties",           &Validator::validate_properties},
  {"required",             &Validator::validate_required},
  {"type",                 &Validator::validate_type},
  {"uniqueItems",          &Validator::validate_uniqueItems},
}
{
  for (auto &validator : m_validators) {
    m_keys.push_back(validator.first);
  }
}

bool Validator::validate(const Json &json)
{
  return validate(json, m_schema);
}

bool Validator::validate(const Json &json, const Schema &schema)
{
  bool result = true;
  for (auto &key : schema) {
    if (std::find(m_keys.begin(), m_keys.end(), key.first) != m_keys.end()) {
...
bool Validator::findRef(const std::string &uri, Schema &schema)
{
  if (uri.find("#") != 0) {
    return false;
  }
...
bool Validator::validate_$ref(const Json &json, const Json &ref, const Schema &)
{
  Schema refSchema;
...
bool Validator::validate_additionalItems(const Json &json, const Json &additionalItems, const Schema &schema)
{
...
bool Validator::validate_additionalProperties(const Json &json, const Json &additionalProperties, const Schema &schema)
{
...
bool Validator::validate_allOf(const Json &json, const Json &allOf, const Schema &)
{
  bool result = true;
...
bool Validator::validate_anyOf(const Json &json, const Json &anyOf, const Schema &)
{
...
bool Validator::validate_dependencies(const Json &json, const Json &dependencies, const Schema &)
{
  bool result = true;
...
bool Validator::validate_enum(const Json &json, const Json &_enum, const Schema &)
{
...
bool Validator::validate_items(const Json &json, const Json &items, const Schema &)
{
  bool result = true;
...
bool Validator::validate_maxItems(const Json &json, const Json &maxItems, const Schema &)
{
  return json.array_items().size() <= maxItems.int_value();
}

bool Validator::validate_maxLength(const Json &json, const Json &maxLength, const Schema &)
{
  return json.string_value().length() <= maxLength.int_value();
}

bool Validator::validate_maxProperties(const Json &json, const Json &maxProperties, const Schema &)
{
  return json.object_items().size() <= maxProperties.int_value();
}

bool Validator::validate_maximum(const Json &json, const Json &maximum, const Schema &schema)
{
...
bool Validator::validate_minItems(const Json &json, const Json &minItems, const Schema &)
{
  return json.array_items().size() >= minItems.int_value();
}

bool Validator::validate_minLength(const Json &json, const Json &minLength, const Schema &)
{
  return json.string_value().length() >= minLength.int_value();
}

bool Validator::validate_minProperties(const Json &json, const Json &minProperties, const Schema &)
{
  return json.object_items().size() >= minProperties.int_value();
}

bool Validator::validate_minimum(const Json &json, const Json &minimum, const Schema &schema)
{
...
bool Validator::validate_multipleOf(const Json &json, const Json &multipleOf, const Schema &)
{
  double integerPart;
  return std::modf(json.number_value() / multipleOf.number_value(), &integerPart) == 0;
}

bool Validator::validate_not(const Json &json, const Json &_not, const Schema &)
{
  return !validate(json, _not.object_items());
}

bool Validator::validate_oneOf(const Json &json, const Json &oneOf, const Schema &)
{
  int count = 0;
...
bool Validator::validate_pattern(const Json &json, const Json &pattern, const Schema &)
{
...
bool Validator::validate_patternProperties(const Json &json, const Json &patternProperties, const Schema &)
{
  bool result = true;
  auto &object = json.object_items();
...
bool Validator::validate_properties(const Json &json, const Json &properties, const Schema &)
{
  bool result = true;
  auto &object = json.object_items();
...
bool Validator::validate_required(const Json &json, const Json &required, const Schema &)
{
  bool result = true;
  auto &object = json.object_items();
...
bool Validator::validate_type(const Json &json, const Json &type, const Schema &schema)
{
  if (type.is_array()) {
...
bool Validator::validate_uniqueItems(const Json &json, const Json &uniqueItems, const Schema &)
{
